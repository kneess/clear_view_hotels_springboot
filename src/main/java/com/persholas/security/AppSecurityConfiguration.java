...
public class AppSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .formLogin().loginPage("/clearview/login").usernameParameter("email").passwordParameter("password").loginProcessingUrl("/clearview/login/authenticate").defaultSuccessUrl("/clearview/home").failureUrl("/clearview/login?error=true").permitAll()
                .and()
